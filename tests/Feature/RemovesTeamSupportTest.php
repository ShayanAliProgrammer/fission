...
test('team support remover deletes team files and restores base stubs', function () {
    ...
    expect($filesystem->exists($basePath.'/app/Models/Team.php'))->toBeFalse();
    expect($filesystem->exists($basePath.'/database/migrations/2026_03_30_000003_create_teams_table.php'))->toBeFalse();
    expect($filesystem->get($basePath.'/routes/web.php'))->toBe($filesystem->get($stubPath.'/routes/web.php'));
    expect($filesystem->get($basePath.'/app/Models/User.php'))->toBe($filesystem->get($stubPath.'/app/Models/User.php'));
    expect($filesystem->get($basePath.'/resources/views/components/⚡navigation.blade.php'))->toBe($filesystem->get($stubPath.'/resources/views/components/⚡navigation.blade.php'));
